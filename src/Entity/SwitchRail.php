...
class SwitchRail
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\RailScale", inversedBy="switchRails")
     * @ORM\JoinColumn(nullable=false)
     */
    private $railScale;

    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\RailConstructor", inversedBy="switchRails")
     * @ORM\JoinColumn(nullable=false)
     */
