...
class CurvedRail
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\RailScale", inversedBy="curvedRails")
     * @ORM\JoinColumn(nullable=false)
     */
    private $railScale;

    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\RailConstructor", inversedBy="curvedRails")
     * @ORM\JoinColumn(nullable=false)
     */
     ...
     * @return $this
     */
    public function setFullCircleRay($ray) {

        $this->fullCircleRay = $ray;
        return $this;
    }
     ...
     * @return float
     */
    public function getFullCircleRay() {

        return $this->fullCircleRay;
    }
