...
class StraightRail
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\RailScale", inversedBy="straightRails")
     * @ORM\JoinColumn(nullable=false)
     */
    private $railScale;

    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\RailConstructor", inversedBy="straightRails")
     * @ORM\JoinColumn(nullable=false)
     */
